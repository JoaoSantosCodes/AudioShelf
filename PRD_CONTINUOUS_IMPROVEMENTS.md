...
- [x] **Gestão de Receitas:** Registro de ganhos e salários para comparação de fluxo.
- [x] **Arquivo Digital de Notas:** Interface de foto e anexo de recibos integrada.
- [x] **Fluxo de Caixa:** Gráfico comparativo entre Entradas vs. Saídas (Ganhos vs. Despesas).
...
- [x] **Haptic Feedback (Mobile):** Adicionar vibrações táteis sutis em ações de conclusão de tarefas.
